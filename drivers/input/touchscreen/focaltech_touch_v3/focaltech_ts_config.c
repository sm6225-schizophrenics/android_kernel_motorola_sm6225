...
static struct focaltech_ic_report_rate_config report_rate_config_info = {
...
int fts_mmi_get_report_rate(struct fts_ts_data *ts_data) {
  ...
  FTS_DEBUG("refresh_rate_ctrl: %d, interpolation_ctrl: %d, "
            "interpolation_flag: %d, refresh_rate: %d",
