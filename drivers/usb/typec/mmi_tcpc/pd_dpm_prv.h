...
static inline bool dpm_check_data_msg_event(struct pd_port *pd_port,
                                            uint8_t msg) {
  return pd_event_data_msg_match(pd_get_curr_pd_event(pd_port), msg);
}

#ifdef CONFIG_USB_PD_REV30
static inline bool dpm_check_ext_msg_event(struct pd_port *pd_port,
                                           uint8_t msg) {
...
static inline int dpm_vdm_reply_svdm_request(struct pd_port *pd_port,
                                             bool ack) {
  return pd_reply_svdm_request_simply(pd_port,
                                      ack ? CMDT_RSP_ACK : CMDT_RSP_NAK);
}
...
extern struct svdm_svid_data *dpm_get_svdm_svid_data(struct pd_port *pd_port,
                                                     uint16_t svid);
...
static inline bool svdm_dfp_inform_modes(struct pd_port *pd_port, uint16_t svid,
                                         bool ack) {
  struct svdm_svid_data *svid_data;
...
static inline bool svdm_dfp_inform_enter_mode(struct pd_port *pd_port,
...
static inline bool svdm_dfp_inform_exit_mode(struct pd_port *pd_port,
                                             uint16_t svid, uint8_t ops) {
  struct svdm_svid_data *svid_data;
...
static inline bool svdm_dfp_inform_attention(struct pd_port *pd_port,
                                             uint16_t svid) {
  struct svdm_svid_data *svid_data;
...
static inline bool svdm_ufp_request_enter_mode(struct pd_port *pd_port,
                                               uint16_t svid, uint8_t ops) {
  struct svdm_svid_data *svid_data;
...
static inline bool svdm_ufp_request_exit_mode(struct pd_port *pd_port,
                                              uint16_t svid, uint8_t ops) {
  struct svdm_svid_data *svid_data;
