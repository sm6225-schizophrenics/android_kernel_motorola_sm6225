...
static int
tcpc_dual_role_prop_is_writeable(struct dual_role_phy_instance *dual_role,
                                 enum dual_role_property prop) {
  int retval = -EINVAL;
  struct tcpc_device *tcpc = dev_get_drvdata(dual_role->dev.parent);
...
static int tcpc_dual_role_set_prop_pr(struct tcpc_device *tcpc,
                                      unsigned int val) {
  int ret;
  uint8_t role;
...
static int tcpc_dual_role_set_prop_dr(struct tcpc_device *tcpc,
                                      unsigned int val) {
  int ret;
  uint8_t role;
...
static int tcpc_dual_role_set_prop_vconn(struct tcpc_device *tcpc,
                                         unsigned int val) {
  int ret;
  uint8_t role;
...
static int tcpc_dual_role_set_prop_mode(struct tcpc_device *tcpc,
                                        unsigned int val) {
  int ret;
