...
extern bool mmi_dfp_u_notify_discover_svid(struct pd_port *pd_port,
                                           struct svdm_svid_data *svid_data,
                                           bool ack);
...
extern int mmi_notify_pe_ready(struct pd_port *pd_port,
                               struct svdm_svid_data *svid_data);
extern bool mmi_dfp_notify_pe_startup(struct pd_port *pd_port,
                                      struct svdm_svid_data *svid_data);
...
static inline void dpm_reaction_set_clear(struct pd_port *pd_port, uint32_t set,
                                          uint32_t clear) {
...
static inline uint32_t dpm_reaction_check(struct pd_port *pd_port,
                                          uint32_t mask) {
