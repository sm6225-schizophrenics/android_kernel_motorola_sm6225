...
#define PE_STATE_HRESET_IF_TX_FAILED(pd_port)                                  \
  {                                                                            \
    pd_port->pe_data.pe_state_flags = PE_STATE_FLAG_HRESET_IF_TX_FAILED;       \
  }
...
#define PE_STATE_DPM_INFORMED(pd_port)                                         \
  {                                                                            \
    pd_port->pe_data.pe_state_flags2 = PE_STATE_FLAG_BACK_READY_IF_DPM_ACK |   \
...
#define VDM_STATE_DPM_INFORMED(pd_port)                                        \
  {                                                                            \
    pd_port->pe_data.vdm_state_flags = VDM_STATE_FLAG_BACK_READY_IF_DPM_ACK |  \
...
static inline void pe_send_swap_request_entry(struct pd_port *pd_port,
                                              uint8_t msg) {
