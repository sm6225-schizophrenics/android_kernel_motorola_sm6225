...
rt_regmap_device_register(struct rt_regmap_properties *props,
  ...
  return rt_regmap_device_register_ex(props, rops, parent, client, client->addr,
                                      drvdata);
}
...
extern int rt_asyn_regmap_block_write(struct rt_regmap_device *rd, u32 reg,
                                      int bytes, const void *src);
extern int rt_regmap_block_read(struct rt_regmap_device *rd, u32 reg, int bytes,
                                void *dst);
...
extern int rt_regmap_update_bits(struct rt_regmap_device *rd,
                                 struct rt_reg_data *rrd, u32 reg, u32 mask,
                                 u32 data);
...
extern int regmap_plat_init(void);
extern void regmap_plat_exit(void);
